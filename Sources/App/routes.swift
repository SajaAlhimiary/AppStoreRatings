...
func routes(_ app: Application) throws {
    ...
    app.post("platform", use: PlatformController.create)
    
    app.get("platform", use: PlatformController.all)
    
    app.put("platform", use: PlatformController.updata)
    
    app.delete("platform",":platformId", use: PlatformController.delete)
    
    app.get("platform", ":platformId", use: PlatformController.getid)
